  ...
  return (
    <div className='relative min-h-screen text-white'>
      ...
      <div className='relative flex min-h-screen'>
        {/* SIDEBAR */}
        <aside className='sticky top-0 hidden h-screen w-[290px] shrink-0 border-r border-white/10 bg-black/60 p-4 backdrop-blur-xl md:block'>
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    [
                      ...
                      isActive
                        ? 'bg-gradient-to-r from-orange-500/30 to-pink-500/20 text-white'
        ...
        <div className='flex min-w-0 flex-1 flex-col'>
          ...
          {/* FOOTER */}
          <footer className='border-t border-white/10 bg-black/60 py-5 text-center text-xs text-white/45 backdrop-blur-xl'>

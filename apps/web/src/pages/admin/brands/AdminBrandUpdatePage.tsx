    ...
    <div className='space-y-6'>
      <div className='flex flex-col gap-3 md:flex-row md:items-center md:justify-between'>
        <div>
          ...
          <h1 className='mt-1 text-3xl font-black tracking-tight text-ink-950'>Chỉnh sửa thương hiệu #{id}</h1>
        </div>
      ...
      <section className='surface-strong rounded-3xl p-6'>
        <label className='block'>
          ...
          <input className='premium-input' defaultValue='Nike' />
        </label>
        ...
        <label className='mt-4 block'>
          ...
          <textarea
            ...
            rows={6}
            defaultValue='Brand description demo...'
          />
        </label>

  ...
  return (
    <div>
      <div className='flex items-center justify-between'>
        <h1 className='text-2xl font-extrabold'>Create Brand</h1>
      ...
      <div className='mt-6 grid gap-6 md:grid-cols-3'>
        <div className='md:col-span-2 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-black/5'>
          <input className='w-full rounded-2xl border p-3' placeholder='Brand name' />
        ...
        <div className='rounded-3xl bg-white p-6 shadow-sm ring-1 ring-black/5'>
          <div className='font-bold'>Brand Logo</div>
